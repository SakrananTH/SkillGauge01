                  ...
                  <div className="form-group" style={{ gridColumn: 'span 2' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        <button type="button" className="pill secondary" onClick={handleSavePreset} style={{ fontSize: '0.8rem', padding: '0.25rem 0.75rem', height: 'auto' }}>
                          <i className='bx bx-save' style={{ marginRight: '4px' }}></i> บันทึกสูตร
                        </button>
                        <button type="button" className="pill secondary" onClick={handleAutoFill} style={{ fontSize: '0.8rem', padding: '0.25rem 0.75rem', height: 'auto' }}>
                          <i className='bx bx-magic-wand' style={{ marginRight: '4px' }}></i> เติมเต็มอัตโนมัติ
                        </button>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', background: '#f8f9fa', padding: '1rem', borderRadius: '8px', border: '1px solid #eee' }}>
                      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1rem' }}>
                      {subcategoryOptions[roundForm.category].map(option => {
                        ...
                        const handleQuotaChange = (difficulty, val) => {
                          const max = stats[difficulty];
                          const clamped = Math.max(0, Math.min(val, max));
                          const newSubQuota = { ...safeQuota, [difficulty]: clamped };
                        ...
                        return (
                          <div key={option.value} style={{ background: '#fff', padding: '0.75rem', borderRadius: '6px', border: '1px solid #e2e8f0', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
                              ...
                              {['easy', 'medium', 'hard'].map(diff => (
                                <div key={diff}>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => handleQuotaChange(diff, parseInt(e.target.value) || 0)}
                      ...
                      <div style={{ width: '220px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fff', padding: '1rem', borderRadius: '6px', border: '1px solid #e2e8f0', alignSelf: 'flex-start' }}>
                        <div style={{
                          width: '100px', height: '100px', borderRadius: '50%', marginBottom: '1rem',
                        ...
                        <div style={{ fontSize: '0.8rem', width: '100%' }}>
                          ...
                          <div style={{ marginTop: '0.5rem', paddingTop: '0.5rem', borderTop: '1px solid #eee', textAlign: 'center', fontWeight: 'bold' }}>รวม {quotaStats.total} / {roundForm.questionCount} ข้อ</div>
                        </div>
                      </div>
                    </div>
                    )}
